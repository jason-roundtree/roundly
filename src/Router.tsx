...
import { PlayerRoundDetails, PlayerRoundPointsEarned, PlayerRounds, PlayerRoundSummary, PlayerRoundScorecard, PlayerHole } from './components/PlayerRound'
import { CreateRound, RoundsList, RoundPlayers, RoundSettings, RoundPointSetting, RoundSummary } from "./components/Round"
...
export default function Router() {
    return (
        <Routes>
            ...
            <Route path="rounds/:id/:name/points" element={<PlayerRoundPointsEarned />} />
            <Route path="rounds/:id/:name/scorecard" element={<PlayerRoundScorecard />} />
            {/* TODO: are both details and summary needed? */}
            <Route path="rounds/:id/:name/round-details" element={<PlayerRoundDetails />} />
            <Route path="rounds/:id/:name/round-summary" element={<PlayerRoundSummary />} />
